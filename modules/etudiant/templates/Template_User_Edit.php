    ...
    <div  class="md-whiteframe-z2" style="padding: 0; margin-bottom: 20px;" ng-controller="UserEditController">
      ...
      <md-content class="md-padding">
        <form ng-submit="save()">
            ...
            <div layout="row">
              <md-input-container class="md-block">
                <md-select ng-model="user.has_secu" placeholder="Sécurité sociale étudiante ?" required>  
                  <md-option ng-value="true">J'ai la sécurité sociale étudiante</md-option>
                  <md-option ng-value="false">Je n'ai pas de sécurité sociale étudiante</md-option>
                </md-select>
              </md-input-container>
              <md-input-container class="md-block flex">
