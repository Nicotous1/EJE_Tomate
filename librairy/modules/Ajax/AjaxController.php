<?php
	include_once("librairy/plugins/WordTemplate/loader.php");
...
*/
		public function SaveEtude() {
			...
			$params = $this->httpRequest->post(array(
				...
				"signataire","entreprise","numero", "admins",
			));
...
*/
		...
		public function TemplateGet() {
			...
			$path = "librairy/plugins/WordTemplate/Generation/Gen_".$n.".docx";
...
*/
		...
		private function DocEtudeGenerate(DocEtude $de) {
			$pathPlugin = "librairy/plugins/WordTemplate/";
